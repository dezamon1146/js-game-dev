    ...
    for(let r=0; r<rows; r++){
        ...
        for(let c=0; c<columns; c++){
            ...
            if(originalRow[c] !== num && num !== 0){
                ...
                //remove the animation classs after animation is complete
                setTimeout(() => {
...
// event listener to chech where you touch the screen and prevents scrolling. input targets any element that includes the word tile.
